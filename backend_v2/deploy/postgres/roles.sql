...
GRANT CONNECT ON DATABASE bda_v2 TO bda_migrator, bda_app, bda_worker;
GRANT USAGE ON SCHEMA public TO bda_migrator, bda_app, bda_worker;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO bda_app, bda_worker;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO bda_app, bda_worker;
ALTER DEFAULT PRIVILEGES FOR ROLE bda_migrator IN SCHEMA public
  GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO bda_app, bda_worker;
ALTER DEFAULT PRIVILEGES FOR ROLE bda_migrator IN SCHEMA public
  GRANT USAGE, SELECT ON SEQUENCES TO bda_app, bda_worker;
...
--    WHERE rolname IN ('bda_migrator', 'bda_app', 'bda_worker');
