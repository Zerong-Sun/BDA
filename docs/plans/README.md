...
| [蛋白质设计能力清单](PROTEIN_DESIGN_FEATURES.md) | 第 1–6 项（序列分析、界面测量、结构叠合、AF3 解析、候选分诊、密码子优化）已于 2026-09-14/15 实现，行为以 [后端 v2 说明](../BACKEND_V2.md) 为准；第 7 项保守性分析已实现，但输入限于人工上传的比对文件——平台目前没有任何插件产出 MSA；第 8 项序列/结构资源 MCP、第 9 项集群作业 MCP 未开始。 |
