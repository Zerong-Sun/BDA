...
function createStrictRoutes({ scenario, routeId }) {
  ...
  add('GET', `/api/v2/projects/${PROJECT_ID}/timeline`, { limit: '100' }, () => ok({
    items: empty
      ? []
      : [{
          id: 'problem_browser_1',
          project_id: PROJECT_ID,
          occurred_at: '2026-07-30T10:00:00Z',
          entry_type: 'problem',
          phase: 'binder-route-a',
          title: 'Interface geometry drifted outside the preregistered gate',
          summary: 'The first route did not retain the intended contact geometry.',
          body: '## Observed problem\n\nThe preregistered interface check failed.',
          outcome: 'refuted',
          provenance: { workflow_run_ids: [workflowRun.id] },
          code_refs: [],
          supersedes_id: null,
          caused_by_id: null,
          tags: ['dry-lab', 'problem'],
          created_by: 'user_browser',
          version: 1,
          created_at: NOW,
          updated_at: NOW,
          ...
          supersedes_id: null,
          caused_by_id: 'problem_browser_1',
          tags: ['dry-lab'],
          created_by: 'user_browser',
          version: 1,
          created_at: NOW,
