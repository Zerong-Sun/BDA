...
import { EnvelopeIcon, TextTIcon, GlobeSimpleIcon, PhoneIcon, BellIcon, ClockIcon, WarningCircleIcon, CheckCircleIcon, ProhibitIcon, UserCheckIcon, UserGearIcon, UsersIcon, StarIcon, BuildingIcon, FunnelSimpleIcon, FunnelXIcon } from "@phosphor-icons/react"
      ...
      fields: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              label: "In Progress",
              icon: (
                <WarningCircleIcon className="stroke-yellow-500" />
              ),
            },
            {
              value: "done",
            ...
            },
            {
              ...
              label: "Cancelled",
              icon: (
                <ProhibitIcon className="stroke-destructive" />
              ),
            },
          ],
        },
