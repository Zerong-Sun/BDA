    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          ...
          // Kept out of the `data-[side=…]:` variants above on purpose: those
          // carry (0,2,0) specificity and a distinct tailwind-merge variant key,
          // so a plain `w-*` / `sm:max-w-*` from `className` could neither win
          // the cascade nor dedupe them away. As a separate argument they are
          // ordinary (0,1,0) utilities that callers can simply override.
