...
export const TOUR_SECTIONS: TourSection[] = [
  {
    ...
    steps: [
      ...
      step('projects', 'main-navigation', '/projects', 'main-navigation', 'button',
        { title: 'Main navigation', body: 'Use the stage cards here to open Research, Workflow, Candidates, or Results. Click View on an available stage; locked stages show what must be completed first.' },
        { title: '主导航', body: '通过这里的阶段卡片进入研究、工作流、候选物或结果。点击可用阶段的“查看”进入；未解锁的阶段会提示前置条件。' }),
    ],
  },
  {
