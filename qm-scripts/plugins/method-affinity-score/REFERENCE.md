# method_affinity_score — 功能、参数与使用手册

> 文档快照：2026-09-15；由 build_reference_docs.py 生成。配置/文档覆盖不等于运行验证。

亲和力评分：当前仅有 demo-1.0 注册记录，输入/输出/参数 schema 均为空。

[统一规范](../../../docs/plugins/STANDARD.md) · [全部插件总览](../../../docs/plugins/INDEX.md) · [结构化解释源](../../../docs/plugins/profiles/method-affinity-score.json)
...
- 缺少原始指标来源、单位/对数转换、评分公式和权重；不能当作 Kd 或 ΔΔG。
