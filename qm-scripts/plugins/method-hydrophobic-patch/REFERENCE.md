# method_hydrophobic_patch — 功能、参数与使用手册

> 文档快照：2026-09-15；由 build_reference_docs.py 生成。配置/文档覆盖不等于运行验证。

疏水斑块惩罚：当前仅有 demo-1.0 注册记录，输入/输出/参数 schema 均为空。

[统一规范](../../../docs/plugins/STANDARD.md) · [全部插件总览](../../../docs/plugins/INDEX.md) · [结构化解释源](../../../docs/plugins/profiles/method-hydrophobic-patch.json)
...
限制：缺少表面定义、探针半径、疏水残基集合、连通/距离准则及面积或惩罚公式；不能宣称输出 SAP。
...
- 缺少表面定义、探针半径、疏水残基集合、连通/距离准则及面积或惩罚公式；不能宣称输出 SAP。
